...
function Header() {
  ...
  <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
   <Image src='/tradelogo.png' alt='logo'
   width={60}
   height={60}/>
    ...
    <div className="flex flex-1 items-center justify-end md:justify-between">
      ...
      <div className="flex items-center gap-4">
        <div className="sm:flex sm:gap-4">
          <a
            className="block rounded-md bg-black px-5 py-2.5 text-sm font-medium text-white transition hover:bg-gray-700"
            href="#"
          >
          ...
          <a
            className="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-black-600 transition hover:text-gray-600/75 sm:block"
            href="#"
          >
